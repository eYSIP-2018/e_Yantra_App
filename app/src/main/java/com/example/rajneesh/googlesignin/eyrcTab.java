...
public class eyrcTab extends Fragment {
    Button register;
    ...
    public void onAttach(Context context) {
        ...
        try {
            callBack = (eyrcTab.OnRegisterSelectedCallBack) context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_eyrc_tab,container,false);
