...
public class eyrdcTab extends Fragment {
    Button register;
    ...
    public void onAttach(Context context) {
        ...
        try {
            callBack = (eyrdcTab.OnRegisterSelectedCallBack) context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_eyrdc_tab,container,false);
